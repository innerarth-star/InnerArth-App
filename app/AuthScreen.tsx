...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: '#ffffff', padding: 30, borderRadius: 20, width: '100%', maxWidth: 420, alignSelf: 'center' },
  logo: { width: Platform.OS === 'web' ? 120 : 90, height: Platform.OS === 'web' ? 120 : 90, alignSelf: 'center', marginBottom: 20 },
  ...
  input: { backgroundColor: '#f8fafc', padding: 15, borderRadius: 12, marginBottom: 15, borderWidth: 1, borderColor: '#e2e8f0', fontSize: 16, color: '#000', height: 55 },
  passwordContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#f8fafc', borderRadius: 12, marginBottom: 15, borderWidth: 1, borderColor: '#e2e8f0', overflow: 'hidden', height: 55 },
  inputPassword: { flex: 1, paddingHorizontal: 15, fontSize: 16, color: '#000', height: '100%', ...Platform.select({ web: { outlineStyle: 'none' } as any }) },
  eyeIcon: { paddingHorizontal: 15, height: '100%', justifyContent: 'center', alignItems: 'center' },
