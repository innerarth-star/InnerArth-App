...
import { StyleSheet, Text, View, TextInput, TouchableOpacity, FlatList, Alert, SafeAreaView, ScrollView, ActivityIndicator, Platform } from 'react-native';
        ...
        <SafeAreaView style={styles.outerContainer}>
            <View style={styles.mainContainer}>
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <Text style={styles.label}>Lista de Alimentos ({alimentos.length})</Text>
                    {alimentos.map((item) => (
...
const styles = StyleSheet.create({
    ...
    title: { fontSize: 24, fontWeight: 'bold', color: '#1e293b', marginBottom: 20, marginTop: 20 },
    form: { backgroundColor: '#fff', padding: 15, borderRadius: 16, marginBottom: 20, borderWidth: 1, borderColor: '#e2e8f0' },
    ...
    unitGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 15 },
    unitBtn: { paddingVertical: 10, paddingHorizontal: 15, borderRadius: 10, borderWidth: 2, borderColor: '#e2e8f0', backgroundColor: '#fff', flexGrow: 1, alignItems: 'center' },
    ...
    itemCard: { flexDirection: 'row', backgroundColor: '#fff', padding: 15, borderRadius: 12, marginBottom: 8, alignItems: 'center', borderWidth: 1, borderColor: '#e2e8f0' },
