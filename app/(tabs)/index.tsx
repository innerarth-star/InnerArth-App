    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <Section num={5} title="Estilo Vida (IPAQ)" color="#f59e0b" icon="walking" activa={seccionActiva} setActiva={setSeccionActiva}>
          ...
          <TextInput style={styles.input} placeholder="Horas sentado" keyboardType="numeric" onChangeText={v=>setIpaq({...ipaq, sentado:v})} />
        ...
        <Section num={6} title="Nutrición y Hábitos" color="#8b5cf6" icon="utensils" activa={seccionActiva} setActiva={setSeccionActiva}>
          ...
          <TextInput style={styles.input} placeholder="Día de tus comidas" onChangeText={v=>setNutricion({...nutricion, descripcionDia:v})} />
          ...
          <Text style={styles.labelSub}>Deseadas:</Text>
          ...
          <Text style={styles.labelSub}>Entrenos:</Text>
          ...
          <TextInput style={styles.input} placeholder="Objetivos" onChangeText={setObjetivo} />
        ...
        {/* BLOQUE 8 - CONSENTIMIENTO COMPLETO */}
        <Section num={8} title="Consentimiento" color="#1e293b" icon="file-signature" activa={seccionActiva} setActiva={setSeccionActiva}>
          <View style={styles.consentBox}>
            ...
            <Text style={styles.consentTxt}>
              1. Propósito y explicación de los procedimientos: Mediante este documento acepto voluntariamente participar en un plan de entrenamiento personal de acondicionamiento físico. También acepto tomar parte en las actividades del programa de entrenamiento personal que se me recomienden para la mejora de mi salud y bienestar general...{"\n\n"}
              2. Riesgos: Manifiesto que se me ha informado de que existe la posibilidad, aunque remota, de efectos negativos durante el ejercicio...{"\n\n"}
              3. Beneficios que cabe esperar: Soy consciente de que este programa puede o no reportar beneficios a mi condición física o salud general...{"\n\n"}
              4. Confidencialidad y uso de la información: Se me ha informado de que la información obtenida se tratará con máxima confidencialidad... Doy mi autorización expresa a que se lleven a cabo todos los servicios y procedimientos tal y como me ha comunicado el personal del programa.
            </Text>
          </View>
